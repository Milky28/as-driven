...
- As Driven dataset 0.5.12 and schema v1.
...
The database currently contains 268 curated car records. Of those, 255 carry AMS2 entries; 4 are currently AC EVO-only and 7 original-AC
