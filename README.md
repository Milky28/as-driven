...
- Dataset 0.4.27 contains 260 reviewed car records under the open v1 JSON
  contract.
...
Dataset 0.4.27 contains 260 reviewed records. Of the 365 exact AMS2 identities
...
Cruze Stock Car 2021 identity remains queued for guided verification. New
content still fails closed until it is observed and reviewed.
4 records carry Assetto Corsa EVO entries, 3 of them shared with AMS2. ACC has 18
reviewed cross-simulator entries. Original Assetto Corsa has 4 AC-only records and 13
...
Dataset 0.4.27 contains 260 curated car records promoted through the reviewed
identity workflow. Of those, 255 carry AMS2 entries; 1 is AC EVO-only and 4 are
