...
See the [generated coverage summary](../README.md#what-it-covers) for current
record totals. This inventory snapshot contains 370
...
Every review-only and guided-verification queue is now empty.
