...
Dataset 0.3.92 contains 242 curated records. The identity inventory contains 333
...
Dataset 0.3.92 replaced all of that with a declaration. A record names its base
