...
Dataset 0.3.23 contains 93 curated records. The refreshed SimHub 9.11.22
...
- 127 observed identities are covered exactly by curated records.
- 98 observed identities are not covered.
- 85 of those need full guided verification, and they are now the only work
...
- No Low Downforce identity is inheritance-ready: dataset 0.3.23 promoted the
  two that batch 02 unblocked. Five more wait on unverified bases.
