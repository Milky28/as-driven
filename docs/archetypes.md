...
**Status: 252 of 263 records are classified** - 181 matches, 45 deviations, 15 undetermined, 11 with no archetype, and 11 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 263 curated records there are **67 distinct transmission blocks**.
...
Only 29 records are one of a kind.
