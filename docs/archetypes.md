...
**Status: 251 of 285 records are classified** - 178 matches, 47 deviations, 15 undetermined, 11 with no archetype, and 34 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 285 curated records there are **86 distinct transmission blocks**.
