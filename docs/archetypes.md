...
**Status: 251 of 279 records are classified** - 180 matches, 45 deviations, 15 undetermined, 11 with no archetype, and 28 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 279 curated records there are **79 distinct transmission blocks**.
...
Only 38 records are one of a kind.
