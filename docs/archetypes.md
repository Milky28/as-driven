...
**Status: 251 of 254 records are classified** - 158 matches, 68 deviations, 14 undetermined, 11 with no archetype, and 3 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 254 curated records there are **72 distinct transmission blocks**.
