...
**Status: 252 of 267 records are classified** - 181 matches, 45 deviations, 15 undetermined, 11 with no archetype, and 15 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 267 curated records there are **70 distinct transmission blocks**.
...
Only 31 records are one of a kind.
