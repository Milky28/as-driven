...
**Status: 252 of 268 records are classified** - 181 matches, 45 deviations, 15 undetermined, 11 with no archetype, and 16 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 268 curated records there are **71 distinct transmission blocks**.
...
Only 32 records are one of a kind.
