...
**Status: 252 of 260 records are classified** - 158 matches, 68 deviations, 15 undetermined, 11 with no archetype, and 8 awaiting classification. `data/v1/archetypes.json` holds 23 archetypes,
...
Across the 260 curated records there are **75 distinct transmission blocks**.
...
Only 33 records are one of a kind.
