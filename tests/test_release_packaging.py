...
class ReleasePackagingTests(unittest.TestCase):
    ...
    def test_package_verifier_rejects_private_release_contents(self) -> None:
        verifier = (
            ROOT / "release" / "test-early-access-package.ps1"
    ...
    def test_prerelease_publisher_is_draft_only_and_requires_approval(self) -> None:
        publisher = (
            ROOT / "release" / "publish-github-prerelease.ps1"
        ).read_text(encoding="utf-8")
        ...
        self.assertIn("test-early-access-package.ps1", publisher)
